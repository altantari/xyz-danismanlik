...
// Simple section header with subtle lamp/glow effect
export const LampHeader = ({
  ...
  return (
    <div
      className={cn(
        "relative flex flex-col items-center justify-center w-full py-20 sm:py-28",
        className
      )}
    >
      ...
      <div className="absolute inset-0 flex items-start justify-center overflow-hidden pointer-events-none">
        ...
        <motion.div
          ...
          className="absolute top-0 w-[40rem] h-40 bg-primary/10 rounded-full blur-3xl"
        />
        ...
        <motion.div
          ...
          className="absolute top-0 h-px bg-gradient-to-r from-transparent via-primary/60 to-transparent"
        />
        ...
        <motion.div
          ...
          className="absolute top-8 w-[20rem] h-24 bg-primary/5 rounded-full blur-2xl"
        />
      </div>

      {/* Children container */}
      <div className="relative z-10 flex flex-col items-center px-4 sm:px-6 lg:px-8 text-center max-w-4xl mx-auto">
        {children}
      </div>
    </div>
  );
...
// Full screen lamp container (original, with green theme)
  ...
  return (
    ...
    >
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0">
        ...
        <div className="absolute inset-auto z-50 h-36 w-[28rem] -translate-y-1/2 rounded-full bg-primary/50 blur-3xl"></div>
        <motion.div
          initial={{ width: "8rem" }}
